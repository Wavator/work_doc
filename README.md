...
- 按月总结的bug,后端问题排查和优化
    - [2207](doc_2207/README.md)
        - [排查redis连接数过高](https://github.com/Wavator/work_doc/tree/main/doc_2207#p1)
        - [排查nginx worker CPU占用100%](https://github.com/Wavator/work_doc/tree/main/doc_2207#p2)
        - [http模块版本较低踩坑](https://github.com/Wavator/work_doc/tree/main/doc_2207#p3)
